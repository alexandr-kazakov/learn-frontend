...
Формы являются одними из важнейших элементов сайта, они встречаются повсеместно. На большинстве коммерческих проектов есть формы. Формы вы будете верстать много и часто, в том числе и сложные, стилизованные. Мы шаг за шагом научимся верстать формы. После выполнения задачи пришлите ссылку на рабочий пример, например на codepen или на страницу на вашем хостинге.  
...
Поясняющее видео: https://drive.google.com/file/d/1upYErdmik32YDUCT_WA8_0bRFjVKMwlx/view   
  ...
  * При фокусировке на поле плавно меняется цвет фона и цвет границы, пример: http://bit.ly/2TnBygM
  * Когда пользователь пишет текст в поле, то цвет введённого текста отличается от цвета текста по умолчанию.
  * При клике на иконку в поле, идёт фокусировка на поле для ввода.
  * При клике на кнопку в поле, идёт фокусировка на самой кнопке, как-бы кнопка независимая.
